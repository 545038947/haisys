...
class GoodsalbumController extends AdminController {
	 /**
     * 商品画册 首页
     * @author 和蔼的木Q <545038947@qq.com>
     */
    ...
    public function del(){
        ...
        if(!$res){
            $this->error(D('Goodsalbum')->getError());
        }else{
            $this->success('删除成功！');
        }
    }
